...
public class Weather_Controller {
    ...
    void initialize() {
        button.setOnAction(actionEvent -> {
            String city = feild_for_country.getText();


            String jsoninformation = new ApiAdapter().adapt("http://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=");
            System.out.println(jsoninformation);
            try {
                String adaptedJson = new JsonAdapter().adapt(jsoninformation);
...
//http://api.openweathermap.org/data/2.5/weather?q= + New York &appid=a572ff64ef842c6f5f11415c68cf55c6
//    http://api.openweathermap.org/data/2.5/weather?q=New%20York&mode=xml&appid=a572ff64ef842c6f5f11415c68cf55c6
